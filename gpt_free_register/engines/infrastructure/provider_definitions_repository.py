...
_BUILTIN_DEFINITIONS: list[dict] = [
    ...
    {
        "provider_type": "mailbox",
        "provider_key": "cloudflare_d1_api",
        "label": "Cloudflare D1 自建邮箱",
        "description": "Cloudflare Email Routing + Worker 落库 D1：本地随机建号，D1 HTTP API 轮询 raw_mails（非 IMAP，非 Worker admin API）",
        "driver_type": "cloudflare_d1_api",
        "default_auth_mode": "token",
        "enabled": True,
        "category": "selfhost",
        "auth_modes": [{"value": "token", "label": "CF API Token"}],
        "fields": [
            ...
            {"key": "cfd1_raw_column", "label": "原文列（可选）", "placeholder": "raw", "category": "connection"},
            {"key": "cfd1_id_column", "label": "ID 列（可选）", "placeholder": "id", "category": "connection"},
            {"key": "cfd1_local_part_length", "label": "本地名长度（可选）", "placeholder": "12", "category": "connection"},
            {"key": "cfd1_local_part_prefix", "label": "本地名前缀（可选）", "placeholder": "", "category": "connection"},
        ],
    },
    {
        "provider_type": "mailbox",
